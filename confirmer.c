...
bool derniere_esquive_droite = true; // mémoire pour retrouver la balise plus vite
...
// On inverse  la vélocité pour que 255 soit vraiment le max 
...
void loop() {
  ...
  switch (etat) {
    ...
    case EVITER_OBSTACLE:
      ...
      // ÉTAPE 2 : L'obstacle n'est plus vu
      right(180);
      delay(250); 
